#This version: 2017 11 03
   ...
   rm(list=ls())  # clean it all
      ...
      library(zoo,lib.loc="/home/urisoh5/R/lib" )        #This library has the additive model with smoothingfunction 

	library(sandwich,lib.loc="/home/urisoh5/R/lib" )     #For robust standard errors
	library(mgcv,lib.loc="/home/urisoh5/R/lib" )        #This library has the additive model with smoothingfunction 
	library(stringr,lib.loc="/home/urisoh5/R/lib" )     #To process strings in the function
	library(lmtest,lib.loc="/home/urisoh5/R/lib" )       #To run linear tests
...
#Function 3 - Check that formula entered into function is ok, and convert to string list
  ...
  #(5.4) Regression split based on adjusted based on z1,z2    
         #Save to png?
            if (pngfile!="") png(filename=pngfile, width=600,res=100) 
        #Run the two lines
