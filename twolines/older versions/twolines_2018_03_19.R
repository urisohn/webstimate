...
#Updates
#2018 03 20:
#    Changed heteroskedasticity robust errors to HC1 because with HC3 it would give "NA" too often
#    Fixed bug in how number of unique x-values were being counted (function had unique(x) instead of length(unique(x))
#
#
####################################################################################
...
reg2=function(f,xc,graph=1,family="gaussian")
{
  ...
  rob1=coeftest(glm1, vcov=vcovHC(glm1,"HC1"))  #Until 2018 03 20 I was using HC3, but they sometimes generate errors, so i switched it to HC1
