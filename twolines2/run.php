...
#Run the rcode
	...
	#Welcome to R syntax
		...
		#Read it
			...
			a=import("/home/urisoh5/uploaded_data/webstimate.org/twolines/temp/$file")
		#die() if file was not loaded in R
			if(!exists("a")) stop("Sorry, R was unable to read the file $file")
			attach(a)
			
		#Run two lines
			r=twolines($f,pngfile="$time.png")  #f is the model entered by the user
...
//Execute it
	exec("/usr/bin/R CMD BATCH ".$time."_twolines");
